package com.example.slavkurochkin.geoquiz;
...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_IS_TRUE
            =
            "com.example.slavkurochkin.geoquiz.answer_is_true";

    private static final String EXTRA_ANSWER_SHOWN =
            "com.example.slavkurochkin.geoquiz.answer_shown";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowAnswer.setOnClickListener(new
           View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   Animator anim = ViewAnimationUtils
                           .createCircularReveal(mShowAnswer,
                                   cx, cy, radius, 0);
    ...
    private void setAnswerShownResult(boolean
                                              isAnswerShown) {
